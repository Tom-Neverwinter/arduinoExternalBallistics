...
double AtmCorrect(double DragCoefficient, double Altitude, double Barometer,
...
double ZeroAngle(int DragFunction, double DragCoefficient, double Vi,
...
int SolveAll(int DragFunction, double DragCoefficient, double Vi,
		double SightHeight, double ShootingAngle, double ZeroAngle,
